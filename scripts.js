...
function Book(id, title, author, pages, genre, coverImg, read) {
    this.id = id
    this.title = title
    this.author = author
    this.pages = pages
...
function getFormData(e) {
    ...
    const bookObject = new Book(id, title, author, pages, genre, coverImg, read )
    return bookObject;
};
...
form.addEventListener("submit", (e) => {
    const bookObject = getFormData(e);
    const add_book_library = addBookToLibrary(bookObject) ;
